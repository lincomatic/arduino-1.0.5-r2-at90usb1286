...
public class Compiler implements MessageConsumer {
  ...
  public boolean compile(Sketch sketch,
    ...
    String gccCommand = boardPreferences.get("build.command.gcc");
    String gppCommand = boardPreferences.get("build.command.g++");
   ...
   objectFiles.addAll(
     compileFiles(avrBasePath, gccCommand, gppCommand, buildPath, includePaths,
   ...
   for (File libraryFolder : sketch.getImportedLibraries()) {
     ...
     objectFiles.addAll(
       compileFiles(avrBasePath, gccCommand, gppCommand,
  ...
  private List<File> compileFiles(String avrBasePath, String gccCommand, String gppCommand,
...
//    }
  ...
  static private List getCommandCompilerS(String avrBasePath, String gccCommand, List includePaths,
  ...
  static private List getCommandCompilerC(String avrBasePath, String gccCommand, List includePaths,
    String sourceName, String objectName, Map<String, String> boardPreferences) {
  ...
  static private List getCommandCompilerCPP(String avrBasePath, String gppCommand,
    List includePaths, String sourceName, String objectName,
    Map<String, String> boardPreferences) {
    
    List baseCommandCompilerCPP = new ArrayList(Arrays.asList(new String[] {
      avrBasePath + gppCommand,
      "-c", // compile, don't link
      "-g", // include debugging info (so errors include line numbers)
      "-Os", // optimize for size
      Preferences.getBoolean("build.verbose") ? "-Wall" : "-w", // show warnings if verbose
